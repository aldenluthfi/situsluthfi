        ...
        <MediaPlayerContext.Provider value={contextValue}>
          <RootPrimitive
            ...
            className={cn(
              ...
              "[&_[data-slider]::before]:-top-6 [&_[data-slider]::before]:-bottom-2 [&_[data-slider]::before]:absolute [&_[data-slider]::before]:inset-x-0 [&_[data-slider]::before]:z-10 [&_[data-slider]::before]:h-12 [&_[data-slider]::before]:content-[''] [&_[data-slider]]:relative",
              className,
            )}
          >
  ...
  return (
    <MediaPlayerTooltip tooltip={isPlaying ? "Pause" : "Play"} shortcut="Space">
      <Button
        ...
        onClick={onPlayToggle}
      >
        {children ?? (isPlaying ? <IconPlayerPauseFilled /> : <IconPlayerPlayFilled />)}
      </Button>
    </MediaPlayerTooltip>
  );
});
...
>((props, forwardedRef) => {
  ...
  return (
    ...
    >
      ...
      >
        {children ?? <IconPlayerSkipForward />}
      </Button>
    </MediaPlayerTooltip>
  );
});
...
>((props, forwardedRef) => {
  ...
  const LoopIcon = React.useCallback(() => {
    if (loopMode === "one") return <IconRepeatOnce />;
    return (
      <IconRepeat className={cn(loopMode === "off" && "text-foreground/60")} />
    );
  }, [loopMode]);
...
>((props, forwardedRef) => {
  ...
  return (
    <MediaPlayerTooltip tooltip="Fullscreen" shortcut="F">
      ...
      >
        {children ?? (isFullscreen ? <IconArrowsMinimize /> : <IconArrowsMaximize />)}
      </Button>
    </MediaPlayerTooltip>
  );
});
...
>((props, forwardedRef) => {
  ...
  return (
    <MediaPlayerTooltip tooltip="Captions" shortcut="C">
      ...
      >
        {children ??
          (captionsEnabled ? <IconMessage2 /> : <IconMessage2Off />)}
      </Button>
    </MediaPlayerTooltip>
  );
});
